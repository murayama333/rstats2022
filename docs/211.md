...
+ dplyr::rowise関数によって、行単位での処理が可能となる
+ rowiseを実行すると実行結果に「# Rowise:」と表示される
...
+ 後述するdplyr::nest_byとよく似ているが、group_nest関数はデータセットをネストするだけのシンプルな関数（nest_by関数は group_nest関数の結果にrowiseを適用する）
...
+ ネストしたデータセットは rowise関数を使うことで効率よく処理できる
...
+ group_nest関数とrowise関数を組み合わせることで、ネストしたデータセットを効率よく処理できる
+ nest_by関数を使えば、group_nest関数とrowise関数をの呼び出しをまとめることができる
...
<img src="img/tidyverse/008.png" width="400px">
...
<img src="img/tidyverse/009.png" width="400px">
...
<img src="img/tidyverse/010.png" width="400px">
